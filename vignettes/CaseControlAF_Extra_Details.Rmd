---
title: "CaseControlAF Extra Details"
author: "Hayley Stoneman"
date: "2024-07-03"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{CaseControlAF Extra Details}
...
For the vignette with basic usage and examples see the CaseControlAF Vignette. 
...
```{r Plot AF results, message=FALSE}
...
```{r plot sex chromosome results, message=FALSE}
